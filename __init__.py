...
SENSOR_TYPES = {
    ...
    TYPE_WINDGUSTKMH: ("Wind Gust", SPEED_KILOMETERS_PER_HOUR,
                       TYPE_SENSOR, None, "mdi:weather-windy"),
    TYPE_TEMPC: ("Outdoor Temperature", TEMP_CELCIUS,
                 TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_TEMP1C: ("Temperature 1", TEMP_CELCIUS,
                  TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_TEMP2C: ("Temperature 2", TEMP_CELCIUS,
                  TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_TEMP3C: ("Temperature 3", TEMP_CELCIUS,
                  TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_TEMPINC: ("Indoor Temperature", TEMP_CELCIUS,
                   TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_DEWPOINTC: ("Dewpoint", TEMP_CELCIUS,
                     TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE, "mdi:thermometer"),
    TYPE_WINDCHILLC: ("Windchill", TEMP_CELCIUS,
